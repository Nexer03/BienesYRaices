      ...
      <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm">
          <thead class="bg-gray-50 dark:bg-gray-900">
              <tr>
                  ...
                  <th class="px-4 py-2 text-right font-medium text-gray-600 dark:text-gray-300">Precio promedio venta</th>
                  <th class="px-4 py-2 text-right font-medium text-gray-600 dark:text-gray-300">Precio promedio renta</th>
              </tr>
          </thead>
          <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
