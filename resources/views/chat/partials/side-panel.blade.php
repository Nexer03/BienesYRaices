    ...
    <div id="chatVisitModal"
      ...
      <div style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);
        ...
        <div class="fp-shell mb-3">
          <input id="chatVisitDatePicker" class="fp-hidden-input" aria-hidden="true" tabindex="-1" />
        </div>
    ...
    <script>
      (function () {
        ...
        const VISIT_SLOT_HOURS = [
          ...
          "13:00","14:00","15:00","16:00","17:00","18:00","19:00" // 19–20
        ];

        const visitSlots = @json($visitSlots ?? []);

        // Elementos principales (card)
        ...
        const pickerInput= document.getElementById('chatVisitDatePicker');
        ...
        if (!openBtn || !modal || !pickerInput) return;
        ...
        const initCalendar = () => {
          const shell = pickerInput.closest('.fp-shell');
          if (!shell || !window.flatpickr) return;
          ...
          visitFp = flatpickr('#chatVisitDatePicker', {
            mode: 'single',
            inline: true,
            static: true,
            appendTo: shell,
